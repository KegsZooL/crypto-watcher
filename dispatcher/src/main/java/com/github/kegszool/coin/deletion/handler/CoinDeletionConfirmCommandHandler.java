...
@Service
public class CoinDeletionConfirmCommandHandler {
    ...
    public CoinDeletionConfirmCommandHandler(MessageUtils messageUtils, FavoriteCoinDeletionService deletionService) {
