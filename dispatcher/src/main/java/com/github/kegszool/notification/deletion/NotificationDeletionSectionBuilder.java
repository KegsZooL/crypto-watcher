...
public class NotificationDeletionSectionBuilder implements SectionBuilder {
    ...
    public NotificationDeletionSectionBuilder(
            @Value("${menu.notification_deletion.prefix}") String callbackDataPrefix,
    ...
    private String buildEntry(NotificationDto notification, String locale) {
        ...
        String callbackData = String.format(
                "%s%s_%s_%s_%s_%s_%s_%s",
                callbackDataPrefix,
                notification.getTargetPercentage(),
                notification.getDirection().name(),
                notification.isRecurring(),
                notification.getInitialPrice(),
                notification.getMessageId(),
                notification.getUser().getTelegramId(),
                coinName
        );
